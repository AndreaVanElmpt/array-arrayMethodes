...
const dobInventors = inventors.filter((inventor) => {
  return inventor.year >= 1500 && inventor.year <= 1600;
})

console.log(dobInventors);
...
const yearInventor = inventors.map((inventorYear) => {
  return inventorYear.year;
...
const nameInventor = inventors.map((inventorName) => {
...
inventors.sort((a, b) => {
const ageLivedA = a.passed - a.year;
const ageLivedB = b.passed - b.year;
return ageLivedB - ageLivedA;
})
console.log(inventors);
...
const edison = inventors.find((inventor) => {

  // Korte manier
  return (inventor.last === 'Edison')

  // lange manier kan beide
